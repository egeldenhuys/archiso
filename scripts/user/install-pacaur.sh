...
# we'll need those.
echo $1 | sudo -S pacman -S binutils make gcc fakeroot pkg-config --noconfirm --needed

# Install pacaur dependencies from arch repos
echo $1 | sudo -S pacman -S expac yajl git --noconfirm --needed
